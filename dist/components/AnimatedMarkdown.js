...
const MarkdownAnimateText = ({ content, sep = "word", animation = "fadeIn", animationDuration = "1s", animationTimingFunction = "ease-in-out", codeStyle = null, htmlComponents = {}, customComponents = {}, }) => {
    ...
    const components = react_1.default.useMemo(() => (Object.assign({ text: (_a) => {
            ...
            return react_1.default.createElement("div", Object.assign({}, props, { style: animationStyle, className: `relative` }),
                ...
                react_1.default.createElement(react_syntax_highlighter_1.Prism, { style: codeStyle, language: (className === null || className === void 0 ? void 0 : className.substring(9).trim()) || '', renderer: (0, exports.customCodeRenderer)({ animation, animationDuration, animationTimingFunction }) }, children));
        }, hr: (_a) => {
            var { node } = _a, props = __rest(_a, ["node"]);
